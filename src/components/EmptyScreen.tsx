  ...
  return (
    <div className="min-h-svh bg-white flex flex-col overflow-hidden">
      ...
      <div className="flex flex-col flex-1 md:hidden overflow-hidden">
        <header className="flex items-center px-8 py-4 bg-[#f2f3fd] rounded-b-2xl shadow-[0_8px_30px_rgba(59,130,246,0.10)] z-10 shrink-0">
          <span
      ...
      <div className="hidden md:flex min-h-svh">
        {/* Sidebar */}
        <aside className="w-70 shrink-0 h-screen bg-[#f8f9fa] border-r border-[#e2e8f0] flex flex-col">
          ...
          <div className="mx-4 px-4 py-6 rounded-2xl bg-[#ecedf7]/50 flex flex-col items-center justify-center text-center gap-2">
            <CheckCircle size={28} stroke="#c2c6d6" strokeWidth={1.5} />
            <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 13, fontWeight: 500 }} className="text-[#757780]">
              No active chats
            </p>
            <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 12 }} className="text-[#a0a3ad]">
...
function IconHalo({ large = false }: { large?: boolean }) {
  ...
  return (
    <div className={`relative ${outer} flex items-center justify-center mb-8 z-10`}>
      ...
      <div className="absolute inset-4 rounded-full bg-[#f2f3fd] border-4 border-white shadow-[inset_0_4px_12px_rgba(0,0,0,0.05)] overflow-hidden flex items-center justify-center">
        <img
          src={avatars.pebble}
          alt=""
          aria-hidden="true"
